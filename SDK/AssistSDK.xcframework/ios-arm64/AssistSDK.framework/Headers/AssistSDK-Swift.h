...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, ScreenQuality, open) {
  ScreenQualityLow = 1,
  ScreenQualityGood = 2,
  ScreenQualityBest = 3,
  ScreenQualityFull = 4,
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, SocketDisconnectStatus, open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, SwitchRollStatus, open) {
