...
#ifndef ASSISTSDK_SWIFT_H
#define ASSISTSDK_SWIFT_H
...
#if defined(__OBJC__)
typedef SWIFT_ENUM(NSInteger, AssistFeatures, open) {
  ...
  AssistFeaturesScreenshot = 17,
};

@class NSString;
@class NSObject;

SWIFT_CLASS("_TtC9AssistSDK19AssistSampleHandler")
@interface AssistSampleHandler : RPBroadcastSampleHandler
- (void)broadcastStartedWithSetupInfo:(NSDictionary<NSString *, NSObject *> * _Nullable)setupInfo;
- (void)broadcastPaused;
- (void)broadcastResumed;
- (void)broadcastFinished;
- (void)finishBroadcastWithError:(NSError * _Nonnull)error;
- (void)processSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer withType:(RPSampleBufferType)sampleBufferType;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9AssistSDK17AssistScreenShare")
@interface AssistScreenShare : NSObject
